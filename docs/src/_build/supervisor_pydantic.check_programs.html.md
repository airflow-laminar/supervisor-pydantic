...
### supervisor_pydantic.check_programs(cfg: ~pathlib.Annotated[~pathlib.Path, <typer.models.OptionInfo object at 0x7fd9d7e45150>] = PosixPath('pydantic.json'), check_running: bool = False, check_done: bool = False, \_exit: ~typing.Annotated[bool, <typer.models.ArgumentInfo object at 0x7fd9d7e451d0>] = True)[[source]](../../../_modules/supervisor_pydantic/convenience/commands.html.md#check_programs)
