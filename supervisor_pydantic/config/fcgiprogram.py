...
class FcgiProgramConfiguration(ProgramConfiguration):
    ...
    socket_backlog: str | None = Field(default=None, description="Sets socket listen(2) backlog.")
    socket_owner: UnixUserNameOrGroup | None = Field(
        default=None,
    ...
    socket_mode: Octal | None = Field(default=None, description="For UNIX domain sockets, this parameter can be used to specify the permission mode.")
