...
class SupervisordConfiguration(_BaseCfgModel):
    ...
    logfile_maxbytes: str | None = Field(
        default=None,
    ...
    logfile_backups: int | None = Field(
        default=None,
    ...
    umask: OctalUmask | None = Field(default=None, description="The umask of the supervisord process.")
    nodaemon: bool | None = Field(default=None, description="If true, supervisord will start in the foreground instead of daemonizing.")
    silent: bool | None = Field(default=None, description="If true and not daemonized, logs will not be directed to stdout.")
    minfds: int | None = Field(
        default=None,
    ...
    strip_ansi: bool | None = Field(default=None, description="Strip all ANSI escape sequences from child log files.")
    ...
    identifier: str | None = Field(default=None, description="The identifier string for this supervisor process, used by the RPC interface.")
