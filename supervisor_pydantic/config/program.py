...
class ProgramConfiguration(_BaseCfgModel):
    ...
    numprocs_start: int | None = Field(default=None, description="An integer offset that is used to compute the number at which process_num starts.")
    ...
    autostart: bool | None = Field(default=None, description="If true, this program will start automatically when supervisord is started.")
    ...
    autorestart: bool | Literal["unexpected"] | None = Field(
        default=None,
    ...
    redirect_stderr: bool | None = Field(
        default=None,
    ...
    stdout_logfile: Path | None = Field(
        default=None,
    ...
    stdout_logfile_maxbytes: str | None = Field(
        default=None,
    ...
    stdout_logfile_backups: int | None = Field(
        default=None,
    ...
    stdout_capture_maxbytes: int | None = Field(
        default=None,
    ...
    stdout_events_enabled: int | None = Field(
        default=None,
    ...
    stdout_syslog: bool | None = Field(default=None, description="If true, stdout will be directed to syslog along with the process name.")
    stderr_logfile: Path | None = Field(
        default=None,
    ...
    stderr_logfile_maxbytes: str | None = Field(
        default=None,
    ...
    stderr_logfile_backups: int | None = Field(
        default=None,
    ...
    stderr_capture_maxbytes: int | None = Field(
        default=None,
    ...
    stderr_events_enabled: bool | None = Field(
        default=None,
    ...
    stderr_syslog: bool | None = Field(default=None, description="If true, stderr will be directed to syslog along with the process name.")
    ...
    umask: OctalUmask | None = Field(default=None, description="An octal number (e.g. 002, 022) representing the umask of the process.")
    serverurl: str | None = Field(
        default=None,
