...
class UnixHttpServerConfiguration(_BaseCfgModel):
    ...
    username: UnixUserName | None = Field(default=None, description="The username required for authentication to this HTTP server.")
